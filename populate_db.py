...
divisions_data = [
    ...
    },
    {
        ...
        "full_description": "Operating state-of-the-art commercial culinary hubs, Central Kitchen prepares wholesome regional specialties and contemporary meal packages. With rigorous hygiene standards, farm-fresh ingredients, and consistent delivery execution, we serve wholesome delight across every order.",
        "division_type": "business",
        "icon_name": "utensils",
