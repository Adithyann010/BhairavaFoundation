...
divisions_data = [
    ...
    },
    {
        ...
        "full_description": "Operating state-of-the-art commercial culinary hubs, BAIRAVA & JK KITCHEN prepares wholesome regional specialties and contemporary meal packages. With rigorous hygiene standards, farm-fresh ingredients, and consistent delivery execution, we serve wholesome delight across every order.",
        "division_type": "business",
        "icon_name": "utensils",
...
offerings_data = {
    ...
    "aadukalam": [
        {"title": "COMMUNITY & CULTURAL ACTIVITIES", "badge": "CULTURE", "description": "Festive cultural gatherings, regional celebrations, and interactive community programs fostering social unity.", "order": 1},
        {"title": "SPORTS & RECREATIONAL ENGAGEMENT", "badge": "SPORTS", "description": "Promoting active lifestyles and sportsmanship through grassroots sports activities, tournaments, and friendly matches.", "order": 2},
        {"title": "LOCAL EVENTS & PARTICIPATION", "badge": "EVENTS", "description": "Inclusive neighborhood programs, public engagement forums, and youth participation initiatives.", "order": 3},
        {"title": "TRADITIONAL & SOCIAL INITIATIVES", "badge": "HERITAGE", "description": "Preserving traditional sports, cultural heritage, and intergenerational social activities for community bonding.", "order": 4},
    ],
    "media": [
...
construction_projects_data = [
    ...
    },
    {
        ...
        "image": "projects/bairava-construction-project.jpg",
        "order": 3,
    },
    {
